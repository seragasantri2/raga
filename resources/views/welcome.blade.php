...
@section('content')
<div class="jumbotron">
  <img src="{{asset('image/home.png')}}" alt="home">
  ...
  <a class="btn btn-primary btn-lg" href="{{ route('register') }}" role="button">Buat website sekarang</a>
    ...
    <div class="header2">
        ...
        <img class="jeruk" src="{{asset('image/jeruk.png')}}" alt="jeruk">
        <img class="baju" src="{{asset('image/baju.png')}}" alt="baju">
        <img class="alkes" src="{{asset('image/alatkebersihan.png')}}" alt="alkes">
        <img class="kemeja" src="{{asset('image/kemeja.png')}}" alt="kemeja">
    ...
    <div class="header3">
      ...
      <div class="pembayaran">
        ...
        <div class=gambar>
          ...
          <img src="{{asset('image/gosend.png')}}" alt="gosend">
          <img src="{{asset('image/alfa.png')}}" alt="alfamart">
          <img src="{{asset('image/indomaret.png')}}" alt="indomaret">
          <img src="{{asset('image/jn.png')}}" alt="jnt">
          <img src="{{asset('image/ninja.png')}}" alt="ninja expres">
