  ...
  <body>
    ...
    <ul class="navbar-nav ml-auto ml-4"> 
      <li class="nav-item active ml-auto">
        <a class="nav-link" href="/reseller"><b> Produk </b><span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/reseller/blog"><b>Blog</b></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/reseller/kontak"><b>Kontak</b></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/resseller/pusatbantuan"><b>Pusat Bantuan</b></a>
      </li>
