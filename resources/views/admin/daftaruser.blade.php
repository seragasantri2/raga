...
<div class="col-md-10 p-5 pt-2">
        <h3><i class="fas fa-user mr-2"></i> DAFTAR USER BIASA</h3><hr>
           ...
           <table class="table table-striped table-bordered">
            ...
            @foreach ($users as $adm)
              <tr>
                ...
                <td>
                <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#ResellerModal{{$adm->id}}"> <i class="fas fa-edit  p-2" data-toggle="tooltip" title="edit"></i></a>
               </td>
              </tr>
            @endforeach
            </tbody>
      ...
      <div class="modal fade" id="ResellerModal{{$row->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
