...
<div class="col-md-10 p-5 pt-2">
        <h3><i class="fas fa-user mr-2"></i> DAFTAR RESELLER </h3><hr>
            ...
            <a class="btn btn-primary mb-3" class="btn btn-primary" data-toggle="modal" data-target="#ResellerModal"><i class="fas fa-plus-square mr-2"></i>TAMBAH RESELLER</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">FORMULIR RESELLER</h5>
